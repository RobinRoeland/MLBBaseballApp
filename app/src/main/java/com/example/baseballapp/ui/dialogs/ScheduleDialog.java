...
import com.example.baseballapp.MainActivity;
...
public class ScheduleDialog extends DialogFragment {
    ...
    public ScheduleDialog(MLBGame game){
        m_game = game;
        bmpForStadium = null;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Team homeTeam = m_game.getHomeTeam(MLBDataLayer.getInstance());
        Team awayTeam = m_game.getAwayTeam(MLBDataLayer.getInstance());
        ...
        if(!m_repo.isOnline() || m_game.isInThePast()) {
            binding.dialogScheduleAccomodation.setVisibility(View.GONE);
            binding.dialogScheduleTickets.setVisibility(View.GONE);
        }
        else {
        ...
        binding.dialogScheduleRoster.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dismiss();
                //spring naar roster fragment
                MainActivity act = (MainActivity)getActivity();
                act.jumpToRosterFragment();
            }
        });
    }
}